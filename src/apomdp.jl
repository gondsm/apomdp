...
function aPOMDP(n_actions,state_values_dict,n_v_s::Int64=1,weights::Array{Float64,1}=normalize(rand(n_v_s),transition_dict, reward_dict,0.95,states,state_indices,state_structure::Array{Int64,1}=[2,3],reward_type::String="svr",agents_size=2,agents_specfi=2,nodes_num=2,world_specfi=3)
